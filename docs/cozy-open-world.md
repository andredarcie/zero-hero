...
| **Persistência** | **Nenhuma.** `localStorage` só guarda volume, idioma e gráficos | Fechar a aba apaga o mundo. Um cozy game é, antes de tudo, **um lugar que lembra de você**. |
